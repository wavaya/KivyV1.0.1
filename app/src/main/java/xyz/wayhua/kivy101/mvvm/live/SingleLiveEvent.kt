package xyz.wayhua.kivy101.mvvm.live
 ...
 */
@Deprecated(
        "Use @see io.mochadwi.util.mvvm#LiveEvent instead to observe an event.",
        ReplaceWith("LiveEvent", "io.mochadwi.util.mvvm#LiveEvent")
)
